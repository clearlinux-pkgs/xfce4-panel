...
Source0  : https://archive.xfce.org/src/xfce/xfce4-panel/4.16/xfce4-panel-4.16.4.tar.bz2
...
%prep
%setup -q -n xfce4-panel-4.16.4
cd %{_builddir}/xfce4-panel-4.16.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651600175
...
cp %{_builddir}/xfce4-panel-4.16.4/COPYING %{buildroot}/usr/share/package-licenses/xfce4-panel/e8f66e6429d9c6e9bb66034ce5da1d6acf12f791
cp %{_builddir}/xfce4-panel-4.16.4/COPYING.LIB %{buildroot}/usr/share/package-licenses/xfce4-panel/aa1d3bf7660105ed6572d5653a1426adf9d358a1
%make_install
