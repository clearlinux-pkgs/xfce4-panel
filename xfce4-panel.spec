...
Source0  : https://archive.xfce.org/src/xfce/xfce4-panel/4.16/xfce4-panel-4.16.5.tar.bz2
...
%prep
%setup -q -n xfce4-panel-4.16.5
cd %{_builddir}/xfce4-panel-4.16.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661289917
