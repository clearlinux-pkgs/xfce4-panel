...
Version  : 4.14.1
Release  : 33
URL      : https://archive.xfce.org/src/xfce/xfce4-panel/4.14/xfce4-panel-4.14.1.tar.bz2
Source0  : https://archive.xfce.org/src/xfce/xfce4-panel/4.14/xfce4-panel-4.14.1.tar.bz2
Summary  : Library for the Xfce Panel
Group    : Development/Tools
License  : GPL-2.0 LGPL-2.1
Requires: xfce4-panel-bin = %{version}-%{release}
Requires: xfce4-panel-data = %{version}-%{release}
Requires: xfce4-panel-lib = %{version}-%{release}
Requires: xfce4-panel-license = %{version}-%{release}
Requires: xfce4-panel-locales = %{version}-%{release}
...
Requires: xfce4-panel-bin = %{version}-%{release}
Requires: xfce4-panel-data = %{version}-%{release}
Provides: xfce4-panel-devel = %{version}-%{release}
...
%package license
Summary: license components for the xfce4-panel package.
Group: Default

%description license
license components for the xfce4-panel package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570066884
...
cp COPYING.LIB %{buildroot}/usr/share/package-licenses/xfce4-panel/COPYING.LIB
%make_install
...
/usr/share/gtk-doc/html/libxfce4panel-2.0/libxfce4panel-XfceHVBox.html
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/xfce4-panel/COPYING
/usr/share/package-licenses/xfce4-panel/COPYING.LIB
